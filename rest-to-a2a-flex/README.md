...
| `a2aConfiguration` | object | — | Optional SendMessage `configuration`: `acceptedOutputModes[]` (enum: `text/plain`, `text/markdown`, `text/html`, `application/json`, `image/png`, `image/jpeg`, `application/pdf`), `blocking` (default true). |
